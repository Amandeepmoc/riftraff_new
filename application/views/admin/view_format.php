            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="/index.php/admin/view_method" method="post" >
                        ...
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button id="send" type="submit" class="btn btn-success">View</button>
                        </div>
