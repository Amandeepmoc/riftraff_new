  <!-- footer content -->
    ...
    <!-- validator -->
    <script src="<?php echo base_url(); ?>admin/vendors/validator/validator.js"></script>
    ...
    <script src="<?php echo base_url(); ?>admin/production/js/moment/moment.min.js"></script>
    <script src="<?php echo base_url(); ?>admin/production/js/datepicker/daterangepicker.js"></script>
    <!-- bootstrap-wysiwyg -->
