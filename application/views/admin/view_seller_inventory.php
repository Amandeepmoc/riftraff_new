...
<?php include("header.php"); ?>
      ...
      <?php foreach ($allproductID as $product){ ?>
        ...
        <?php  if(($product->approve_status == 0) && ($this->uri->segment(2) == 'view_seller_inventory')) { ?>
			
		<a href ="/index.php/Category/approve_seller/<?php echo $product->id; ?>" type="button" class="btn btn-success">Unapproved</a>
                                                      <?php } else { ?>	
        <a href ="/index.php/Category/unapprove_seller/<?php echo $product->id; ?>/dealer" type="button" class="btn btn-success">Approve</a>
