          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update seller <small></small></h2>
      ...
      <?php foreach ($seller as $sell){ ?>
					  ...
					  <input type="hidden" name="id" value="<?php echo $sell->id; ?>" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="title" value="<?php echo $sell->firstname; ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="20"  name="firstname"  type="text">  
                        </div>
                        <br></br>
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Lastname <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="title" value="<?php echo $sell->lastname; ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="20"  name="lastname"  required="required" type="text">
                        </div>
                        <br></br>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <?php 
                            if(($sell->approve_status == 0) && ($this->uri->segment(2) == 'view_user'))
                            { ?>
                                     <a href ="/index.php/admin/approve_user/<?php echo $sell->id; ?>/dealer" type="button" class="btn btn-success">Approve</a>
                          <?php  } if(($sell->status == 0) && ($this->uri->segment(2) == 'view_user_delete'))
                          { ?>
                                    <a href ="/index.php/admin/recover_user/<?php echo $sell->id; ?>/dealer" type="button" class="btn btn-success">Recover</a>
                        <?php } ?>
