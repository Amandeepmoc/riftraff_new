            ...
            <div class="row">
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <ul class="list-inline sell">
                        ...
                        <li class="text-danger text-uppercase text-bold" style="vertical-align:bottom;"><a href="/index.php/riftraff/clearance" class="text-danger"><b>Clearance</b></a></li>
                    </ul>
                </div>
                <div class="col-md-6 col-xs-12 col-sm-6">
...
<?php } ?>
                        <li><a href = "/index.php/riftraff/add_to_cart">Cart  &nbsp;&nbsp;<i class="fa fa-shopping-cart text-muted" aria-hidden="true" ></a></i> </li>
        ...
        <nav class="navbar navbar-default grad" id="custom-nav">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>" style="padding:0px 15px;"><img src="<?php echo base_url(); ?>images/logo4.png" class="logo1" style=""></a>
                </div>
                <br>
...
<?php //}  ?>
                        ...
                        <li class="dropdown">
                            <a href="/index.php/riftraff/dealer_locater" class="" data-toggle="" role="button" aria-haspopup="true" aria-expanded="false">Dealer Locator</a>
                            <!--                            <ul class="dropdown-menu">
...
<?php if (!empty($this->session->userdata['logged_in'])) { ?>
            ...
            <div class="layout-right-content" >
                <header class="the-header" style="position:absolute;">
