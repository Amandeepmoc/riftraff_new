...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <?php
            if (!empty($edit_product_phase)) {
                $newr = $edit_product_phase;
            } else {
                $newr = $edit_product_phasse;
            } foreach ($newr as $dd) {
                ?> 
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    ...
                    <select name="category" class="form-control" id="Selectcat">
                        ...
                        foreach ($category as $categry) {
                            if ($categry->id == $dd->category_id) {
                                ?>
                                <option value="<?php echo $categry->id; ?>" selected ><?php echo $categry->category_name; ?></option>
                    ...
                    <select name="sub_category" class="form-control" id="cat">
                        ...
                        if (!empty($sub_category)) {
                            foreach ($sub_category as $categry) {
                                if ($categry->id == $dd->sub_category_id) {
                                    ?>
                                    <option value="<?php echo $categry->id; ?>" selected ><?php echo $categry->sub_category_name; ?></option>
                ...
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Give your listing a descriptive title" value = "<?php echo $dd->product_name; ?>" required >
                </div>
            <?php } ?>   
            <!-- </form> -->
        </div>
                ...
                <div class="col-md-2 col-sm-12 col-xs-12">
                    ...
                    <?php foreach ($content as $attribute) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="<?php echo $attribute->attribute_code; ?>" class="form-control select_brand calltoimage" id="brand">
                                    ...
                                    foreach ($brands as $brand) {
                                        if ($brand->id == $attribute->attribute_value) {
                                            ?>
                        ...
                        if ($attribute->attribute_code == 'model_name') {
                            ?>
                            <div class="form-group">
                                <input type="text" name="<?php echo $attribute->attribute_code; ?>" class="form-control" id="pwd" placeholder="Brand Model" value="<?php echo $attribute->attribute_value; ?>">
                            </div>
                            <?php
                        }
                    } foreach ($content as $attribute) {
                        if ($attribute->attribute_code == 'model_year') {
                            ?>
                            <div class="form-group">
                                <input type="text" name="<?php echo $attribute->attribute_code; ?>" class="form-control" id="pwd" placeholder="Year" value="<?php echo $attribute->attribute_value; ?>">
                            </div>
                            <?php
                        }
                    } foreach ($content as $attribute) {
                        if ($attribute->attribute_code == 'cost_price') {
                            ?>
                            <div class="form-group">
                                <input type="text" name="<?php echo $attribute->attribute_code; ?>" class="form-control" id="pwd" placeholder="Price" value="<?php echo $attribute->attribute_value; ?>" >
                            </div>
                            <?php
                        }
                    }
                    ...
                    <div class="bbox">
                        ...
                        if (!empty($edit_product_phase)) {
                            ...
                            <div class="checkbox">
                                ...
                                <label><input name="hh" type="checkbox" value="hot_sale" <?php
                                    if ($dd->sale_price != '') {
                                        echo "checked";
                                    } else {
                            ...
                            <div class="form-group">
                                <input name="sale_price" type="text" class="form-control" id="pwd" placeholder="Sale Price" value="<?php
                                if ($dd->sale_price != '') {
                                    echo $dd->sale_price;
                                } else {
                            ...
                            <div class="form-group">
                                <input name="original_price" type="text" class="form-control" id="pwd" placeholder="Original Price" value="<?php
                                if ($dd->original_price != '') {
                                    echo $dd->original_price;
                                } else {
                        ...
                        foreach ($content as $attribute) {
                            if ($attribute->attribute_code == 'product_desc') {
                                ...
                                <div style="padding:0px 10px;">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name = "<?php echo $attribute->attribute_code; ?>"rows="5" id="comment"><?php echo $attribute->attribute_value; ?></textarea>
                                    </div>
                                </div>
                                <?php
                            }
                                        ...
                                        if ($i == 0) {
                                            ...
                                            <?php if ($attribute->attribute_type == 'text') { ?>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="exampleSelect1"><?php echo $attribute->attribute_label; ?></label>
                                                        <input type="text" name="<?php echo $attribute->attribute_code; ?>" class="form-control  Div1" id="exampleInputEmail1" placeholder="<?php echo $attribute->attribute_label; ?>" value="<?php echo $attribute->attribute_value; ?>" required>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="col-md-3 col-sm-2 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name = "<?php echo $attribute->attribute_code; ?>" class="form-control">
                                                            ...
                                                            foreach ($rr as $d) {
                                                                ?>
                                                                <?php if ($attribute->attribute_value == $d) {
                                                                    ?>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        ...
                        <div class="border">
                            ...
                            <div class="row" style ="padding:10px 20px;">
                                ...
                                <?php
                                if (!empty($shipping_d)) {
                                    foreach ($shipping_d as $ddd) {
                                        ?>
                                        <label for="exampleSelect1">where are you shipping from?</label>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label for="exampleSelect1">Country</label>
                                                <input type="text" name="from_country" class="form-control" id="exampleInputEmail1" value = "<?php echo $ddd->from_country; ?> " placeholder="From country"required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <ul class="list-inline">
                                                <?php
                                                $aa[] = explode('-', $ddd->shipping_method);
                                                if (count($aa[0]) > 0) {
                                                    for ($i = 0; $i < count($aa[0]); $i++) {
                                                        ...
                                                        <?php } else if (($aa[0][$i] == 'local_pickup') && ($aa[0][$i] == 'shipping')) {
                                                            ?>
                                                            <li><div class="checkbox">
                                                                    <label><input type="checkbox" class="shipping" name="shipping[]" value="shipping"  checked >Shipping</label>
                                                                </div></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 for_local" <?php if (!empty($ddd->local_pickup)) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pickup_address" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php if (!empty($ddd->local_pickup)) {
                                                    echo $ddd->local_pickup;
                                                } else {
...
<?php } ?>
                ...
                <div class="col-md-5 col-sm-12 col-xs-12 upload-image1" >
                    <div class="col-md-12 col-sm-12 col-xs-12"> 
                        <p>Upload Image</p>
                        <form action="/index.php/riftraff/insert_product_phase_finall" class="dropzone"  method="post"  >
                            <input type="hidden" name="pro_id" value="<?php echo $this->uri->segment(3); ?>">
                        </form>
                    </div>
                </div>
