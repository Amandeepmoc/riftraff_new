...
<main >
    <form action="/index.php/riftraff/seller_account_info" method="post" enctype="multipart/form-data">
					<div class="col-md-11">
						<div class="row">
							<div class="col-md-8">
								...
								<div class="col-md-9 account-right">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input type="numbers" class="form-control" id="text1" name="phone_num" required>
										</div>
									</div>
<!--									<div class="col-md-6">
										<div class="form-group">
...
<!--									<div class="col-md-6">
										<div class="form-group">
											<label for="text">Theme Color:</label><br>
											<input type="text" class="jscolor form-control">
										</div>
									</div>-->
<!--									<div class="col-md-6">
										<div class="form-group">
