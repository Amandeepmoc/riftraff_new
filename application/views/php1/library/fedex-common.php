...
function getProperty($var){
  ...
  if($var == 'key') Return '5nQJEe5PnMFRaXLZ'; 
	if($var == 'password') Return 'vcfVsxZsvwbev0jBzhINH6wt8'; 
	if($var == 'shipaccount') Return '510087887';
	if($var == 'billaccount') Return '510087887';
